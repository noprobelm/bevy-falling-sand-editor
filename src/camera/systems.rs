...
use crate::tools::{earthquake::EarthquakeBrushState, painter::PainterBrushState};
    ...
    fn build(&self, app: &mut App) {
        app.add_systems(
            ...
            (
                ...
                handle_zoom_target
                    .run_if(not(in_state(PainterBrushState::Resize)))
                    .run_if(not(in_state(EarthquakeBrushState::Resize))),
            )
                .chain()
