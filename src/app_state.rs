...
pub fn hide_cursor(mut primary_cursor_options: Single<&mut CursorOptions, With<PrimaryWindow>>) {
    primary_cursor_options.visible = false;
}

pub fn show_cursor(mut primary_cursor_options: Single<&mut CursorOptions, With<PrimaryWindow>>) {
...
pub fn toggle_particle_movement_logic(
    ...
    particle_movement_source: Res<MovementSource>,
) {
    match *particle_movement_source {
...
pub fn step_simulation(mut evw_simulation_step: MessageWriter<SimulationStepSignal>) {
    evw_simulation_step.write(SimulationStepSignal);
}
